...
namespace ViharaFund.Infrastructure.Services
{
    public class AzureBlobService(IConfiguration configuration) : IAzureBlobService
    {
        ...
        public async Task<string> UploadFileAsync(Stream fileStream, string fileName, string contentType, string containerName, PublicAccessType publicAccessType = PublicAccessType.None)
        {
